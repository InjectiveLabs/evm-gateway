...
// Client is an autogenerated mock type for the CometRpcClient type
type Client struct {
	mock.Mock
}

// ABCIInfo provides a mock function with given fields: ctx
func (_m *Client) ABCIInfo(ctx context.Context) (*coretypes.ResultABCIInfo, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) BroadcastEvidence(ctx context.Context, ev types.Evidence) (*coretypes.ResultBroadcastEvidence, error) {
...
func (_m *Client) BroadcastTxAsync(ctx context.Context, tx types.Tx) (*coretypes.ResultBroadcastTx, error) {
...
func (_m *Client) BroadcastTxCommit(ctx context.Context, tx types.Tx) (*coretypes.ResultBroadcastTxCommit, error) {
	ret := _m.Called(ctx, tx)
...
func (_m *Client) BroadcastTxSync(ctx context.Context, tx types.Tx) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(ctx, tx)
...
func (_m *Client) CheckTx(ctx context.Context, tx types.Tx) (*coretypes.ResultCheckTx, error) {
	ret := _m.Called(ctx, tx)
...
func (_m *Client) ConsensusState(ctx context.Context) (*coretypes.ResultConsensusState, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) DumpConsensusState(ctx context.Context) (*coretypes.ResultDumpConsensusState, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) Genesis(ctx context.Context) (*coretypes.ResultGenesis, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) GenesisChunked(ctx context.Context, id uint) (*coretypes.ResultGenesisChunk, error) {
...
func (_m *Client) Health(ctx context.Context) (*coretypes.ResultHealth, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) NetInfo(ctx context.Context) (*coretypes.ResultNetInfo, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) NumUnconfirmedTxs(ctx context.Context) (*coretypes.ResultUnconfirmedTxs, error) {
	ret := _m.Called(ctx)
...
func (_m *Client) SetLogger(l *slog.Logger) {
	_m.Called(l)
}
...
func (_m *Client) Status(ctx context.Context) (*coretypes.ResultStatus, error) {
	ret := _m.Called(ctx)
