...
// NOTE: For more info about the current status of this endpoints see https://github.com/InjectiveLabs/injective-core/injective-chain/issues/124
type PublicAPI struct {
	logger *slog.Logger
}

// NewPublicAPI creates a new tx pool service that gives information about the transaction pool.
func NewPublicAPI(logger *slog.Logger) *PublicAPI {
	return &PublicAPI{
